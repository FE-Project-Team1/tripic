...
function Profile() {
  ...
  {/* 프로필 이미지 영역 (빈 공간으로 유지) */}
    ...
    <div className="flex flex-col items-center text-center w-full">
      ...
      <p className="text-sm text-gray mt-[16px] mb-[24px]">애월을 감귤 전국 배송, 곶감키 제철, 감귤 농장</p>
    </div>
    <div className="flex flex-row items-center justify-center w-full mb-[26px] gap-[10px]">
      <button>
        <img src={messageBtn} alt="메시지" />
      </button>
      <button className="w-[120px] h-[34px] bg-[#F26E22] rounded-[30px] text-white text-[14px] font-medium flex items-center justify-center">팔로우</button>
      <button>
