    ...
    <article className="w-[358px] h-[434px]">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-start gap-[12px]">
          ...
          <div>
            <p className="text-[14px] font-bold pt-[4px] pb-[2px] ">애월읍 위니브 감귤농장</p>
            <p className="text-[12px] text-gray w-[107px] h-[14px]">@weniv_Mandarin</p>
          </div>
        </div>
        <button>
      ...
      <p className="text-[10px] text-gray mt-[16px] mb-[4px] pl-[54px] px-[15px]">2020년 10월 21일</p>
    </article>
  );
}
